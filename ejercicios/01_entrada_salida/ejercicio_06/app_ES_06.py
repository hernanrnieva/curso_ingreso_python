...
class App(customtkinter.CTk):
    ...
    def btn_sumar_on_click(self):
        titulo_alert = "Esto es un alert"

        primer_entero = int(self.txt_operador_a.get())
        segundo_entero = int(self.txt_operador_b.get())
        suma = primer_entero + segundo_entero

        alert(titulo_alert, suma)
